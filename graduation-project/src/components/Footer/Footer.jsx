...
export default function Footer() {
  ...
  return (
    <footer className="app-footer text-light mt-5">
      <div className="container py-5">
        <div className="row gy-5 align-items-start">
          ...
          <div className="col-12 col-lg-4 text-center text-lg-start">
            ...
            <p className="mb-4" style={{ lineHeight: "1.8", color: "#9aa39d" }}>
            ...
            <div className="d-flex flex-column gap-3">
              {links.map(({ label, to }) => (
                <Link
                  key={label}
                  to={to}
                  className={`footer-link text-decoration-none ${activeLink === label ? "active" : ""}`}
          ...
          <div className="col-12 col-md-6 col-lg-4 text-center text-lg-end">
            ...
            <p className="mb-1" style={{ color: "#9aa39d" }}>support@voltmarket.com</p>
            <p style={{ color: "#9aa39d" }}>+20 114 808 4532</p>
          </div>
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
          <p className="m-0 small" style={{ color: "#9aa39d" }}>© 2026 Volt Market. All Rights Reserved.</p>
          <span className="small" style={{ color: "#9aa39d" }}>Made using React and Bootstrap</span>
        </div>
